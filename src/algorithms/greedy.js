...
// previous node for backtracking from the finish node.
...
// Works when called *after* greedyBestFirstSearch.
export function getNodesInShortestPathOrder_gbfs(finishNode) {
